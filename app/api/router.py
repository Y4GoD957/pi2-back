...
from app.api.routes.politicas_publicas import router as politicas_publicas_router
...
api_router.include_router(politicas_publicas_router, prefix=settings.api_v1_prefix)
